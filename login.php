...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <nav class="navbar navbar-expand-lg" style="background-color: #D2B48C; color: #fff;">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold fs-3 ms-2" href="home.php">BERANDA </a>
    ...
    <h1 class="text-center mt-5 mb-4">LOGIN ADMIN</h1>
